		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Esperamos esuchar de ti</h2>
				</div>
			</div>
			<div class="row justify-content-center">
				<div class="col-lg-11">
					<div class="wrapper">
						<div class="row no-gutters justify-content-between">
				        	...
				        	<div class="dbox w-100 d-flex align-items-start">
				        		...
				        		<div class="text pl-4">
					            <p><span>Dirección:</span> Cdla. Universitaria (Predios Huachi)/ Casilla 334</p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-start">
				        		<div class="icon d-flex align-items-center justify-content-center">
				        	...
				        	<div class="dbox w-100 d-flex align-items-start">
				        		...
				        		<div class="text pl-4">
					            <p><span>Email:</span> <a href="mailto:info@yoursite.com">deividjosue52@gmail.com</a></p>
					          </div>
				          </div>
				        	<div class="dbox w-100 d-flex align-items-start">
				        		<div class="icon d-flex align-items-center justify-content-center">
